...
{  
  ...
  EXPECT_EQ(18, result[0][1]);
  EXPECT_EQ(27, result[1][0]);
  EXPECT_EQ(36, result[1][1]);
}
...
TEST(TDynamicMatrix, can_multiply_matrix_by_vector)
{
  ...
  EXPECT_EQ(14, result[0]);  // 1*1 + 2*2 + 3*3 = 14
  EXPECT_EQ(32, result[1]);  // 4*1 + 5*2 + 6*3 = 32
  EXPECT_EQ(50, result[2]);  // 7*1 + 8*2 + 9*3 = 50
}

TEST(TDynamicMatrix, can_multiply_matrices)
{
  TDynamicMatrix<int> m1(2), m2(2);
  ...
  EXPECT_EQ(19, result[0][0]);  // 1*5 + 2*7 = 19
  EXPECT_EQ(22, result[0][1]);  // 1*6 + 2*8 = 22
  EXPECT_EQ(43, result[1][0]);  // 3*5 + 4*7 = 43
  EXPECT_EQ(50, result[1][1]);  // 3*6 + 4*8 = 50
}
